...
![Data Insights Agent within the AI Assistant](images/cja-agent//cja-ai-asst-da.gif)
...
* **Permissions**: Necessary permissions must be granted in the [!UICONTROL Adobe Admin Console] before users can access Data Insights Agent. 
  ...
  To grant permissions, a [product profile admin](https://helpx.adobe.com/enterprise/using/manage-product-profiles.html) must complete the following steps in the [!UICONTROL Admin Console]:
   ...
   1. In the specific product profile, select the **[!UICONTROL Permissions]** tab.
      ...
      ![Permissions tab in Admin Console](images/cja-agent/ai-assistant-permissions-tab.png)

   1. In the **[!UICONTROL Reporting Tools]** row in the provided table, select the edit icon ![Edit](images/cja-agent/Edit.svg).
   1. Scroll to or search for **[!UICONTROL AI Assistant: Product Knowledge]**, then select the plus icon ![AddCircle](images/cja-agent/AddCircle.svg) next to this permission. 
   1. Scroll to or search for **[!UICONTROL Data Insights Agent]**, then select the plus icon ![AddCircle](images/cja-agent/AddCircle.svg) next to this permission. 
      ...
      ![Add permission](images/cja-agent/ai-assistant-permissions.png).
...
**Prompt:** Enter *"Trend orders in July."*
   ...
   ![AI prompt](images/cja-agent/ai-asst-prompt1.png)
...
**Response:** Data Insights Agent gathers insights by looking through the data in the data view, including the metrics and components. It translates the prompt into the right dimensions and metrics within the data range.
   ...
   ![Answer to prompt - line graph and freeform table](images/cja-agent/ai-asst-result.png)
...
**Response:** Data Insights Agent intelligently understands that by "region," you mean "customer region." It produces a bar chart that best shows revenue by region:
   ...
   ![Bar chart](images/cja-agent/ai-asst-result2.png)
...
**Response:** The **[!UICONTROL Bar]** chart still provides the most concise answer, but the profit metric has been added as a column in the freeform table:
   ...
   ![Bar chart](images/cja-agent/ai-asst-result4.png)
...
For more information, see [Adobe Experience Platform Agent Orchestrator](/help/agents/agent-orchestrator.md).
