...
| 代理程式 | 詳細資料 | 支援的應用程式 |
| --- | --- | --- |
|  [!DNL Microsoft 365 Copilot][&#128279;](ama-ms.md)的Adobe Marketing Agent | 立即從[!DNL Microsoft 365]應用程式（例如[!DNL Teams]、[!DNL Word]、[!DNL Powerpoint]和[!DNL Excel]）中的Adobe Experience Platform擷取行銷深入分析。 有了此代理程式，您可以跨應用程式維護聊天記錄，在工作時順暢地繼續您的交談。 | |
