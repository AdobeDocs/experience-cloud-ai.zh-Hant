---
title: 存取CX Enterprise MCP工具
description: 使用Adobe CX Enterprise MCP工具之前，請確認產品可用性、組織啟用和許可權。
...
# 存取CX Enterprise MCP工具 {#mcp-access}
...
如需Beta或限量版產品工具的相關資訊，請聯絡您的Adobe客戶代表，並指定要使用哪些Adobe的CX Enterprise MCP產品工具。 您的代表可協調產品啟用，並在您的Adobe組織準備好時確認。
...
下一步： [安裝適用於CX Enterprise MCP的Adobe](install.md)。